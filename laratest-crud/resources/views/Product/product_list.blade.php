                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        <div class="product-image">
                            <img src="{{asset('/upload')}}/{{$product->product_image}}" class="img-responsive">
                            <span class="tag2 hot">
                                HOT
                            </span>
                        </div>
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                        ...
                        <div class="product-info smart-form">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{url('product/edit')}}/{{$product->product_id}}" class="btn btn-primary">Edit</a>
                                    <a href="{{url('product/delete')}}/{{$product->product_id}}" class="btn btn-danger">Remove</a>
                                </div>
                                <div class="col-md-12">
